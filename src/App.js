...
import CourceDescription from './panels/CourceDescription';
            ...
            setSnackbar(
                <Snackbar
                    ...
                    before={
                        <Avatar
                            size={24}
                            style={{ backgroundColor: 'var(--dynamic_red)' }}>
    ...
    return (
        <View activePanel={activePanel} popout={popout}>
            ...
            <Shop
                ...
                go={go}
                route={ROUTES.HOME}
                desc_panel={ROUTES.COURCE_DESC}
            />
            <CourceDescription
                id={ROUTES.COURCE_DESC}
                go={go}
                route={ROUTES.SHOP}></CourceDescription>
        </View>
    );
};
